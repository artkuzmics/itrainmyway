...
class Quize(admin.ModelAdmin):
    list_display = ('timestamp','gender','age','time','money','contactsport','how','fitnesslevel','height','alone','group','family','flexibility','focus','lower_body','balance','endurance','yes','no','likely_to_recommend')
